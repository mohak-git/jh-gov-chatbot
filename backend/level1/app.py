...
import level1.config as config
...
from level1.vectorstore import FaissStore
from level1.ingest import ingest_pdfs
from level1.rag import RAGPipeline, EmbeddingsClient, GeminiClient
...
# App Init
app = FastAPI(
    title="Jharkhand Policies RAG Backend (Level 1)",
    version="1.0.0",
)
