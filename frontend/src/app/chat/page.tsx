                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-xl border transition-all duration-200 ${serverStatus?.status === "healthy"
                                ...
                                <FiChevronDown
                                    className={`w-4 h-4 transition-transform duration-200 ${isServerStatusOpen ? "rotate-180" : ""
                                        }`}
                                />
                            </button>
                                ...
                                {isServerStatusOpen && (
                                    <motion.div
                                        ...
                                        <div className="flex items-center gap-2 mb-2">
                                            <ServerStatusIcon
                                                className={`w-5 h-5 ${serverStatus?.status ===
                                                    "healthy"
                                                    ? "text-emerald-400"
                                                    : serverStatus?.status ===
                                                        "warning"
                            ...
                            <>
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border transition-all duration-200 ${uploadedFiles
                                            ? "border-emerald-500/50 bg-emerald-500/10 text-emerald-300"
                        ...
                        <div className="relative">
                            <button
                                ...
                                <div
                                    className={`w-3 h-3 rounded-full bg-gradient-to-r ${LevelConfig[
                                ...
                                <FiChevronDown
                                    className={`w-4 h-4 transition-transform duration-200 ${isLevelDropdownOpen ? "rotate-180" : ""
                                        }`}
                                />
                            </button>
                                        ...
                                        {[3, 2, 1, 0].map((level) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center gap-3 px-4 py-3 text-left transition-all duration-200 ${selectedLevel === level
                                                        ? "bg-gray-700/50"
                                ...
                                <div className="grid grid-cols-4 gap-4 mt-8">
                                    {Object.entries(LevelConfig).map(
                                        ([level, config]) => (
                                            <div
                                                key={level}
                                                className={`p-4 rounded-xl border ${selectedLevel ===
                                                    parseInt(level)
        ...
        <motion.div
            ...
            <div className="max-w-[80%]">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div
                        className={`px-2 py-1 bg-gradient-to-r ${levelConfig.color
                            }/20 text-${levelConfig.color.split(" ")[1].split("-")[1]
